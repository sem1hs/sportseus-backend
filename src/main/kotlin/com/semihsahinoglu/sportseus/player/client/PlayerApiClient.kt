...
import com.semihsahinoglu.sportseus.squad.dto.squad.SquadApiEnvelope
import com.semihsahinoglu.sportseus.squad.dto.squad.SquadApiItem
...
class PlayerApiClient(
    ...
    // /players/profiles?player=X → tek oyuncu profili (yoksa null)
    ...
    // /players?id=X&season=Y → oyuncu + statistics[] (yoksa null)
    ...
    // /players/teams?player=X → takım geçmişi (tüm takımlar, sezonlarıyla)
